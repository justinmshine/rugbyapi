    ...
    <div class="">
        ...
        <div class="items-wrapper">
            <div class="item-single-title">
                <div class="item-bar-code item-width">Bar Code</div>
                <div class="item-qr-code item-width">QR Code</div>
            </div>
            @foreach($items as $out)
                <div class="item-single">
                    <div class="item-bar-code item-width">{{ $out->bar_code }}</div>
                    <div class="item-qr-code item-width">{{ $out->qr_code }}</div>
