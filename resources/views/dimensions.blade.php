    ...
    <div class="">
        ...
        <div class="items-wrapper">
            <div class="item-single-title">
                ...
                <div class="item-waste item-width">Waste</div>
                <div class="item-length item-width">Length</div>
                <div class="item-chest item-width">Chest</div>
            </div>
            @foreach($items as $out)
                <div class="item-single">
                    <div class="item-type item-width">{{ $out->type }}</div>
                    <div class="item-waste item-width">{{ $out->waste }}</div>
                    <div class="item-length item-width">{{ $out->length }}</div>
                    <div class="item-chest item-width">{{ $out->chest }}</div>
